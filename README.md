...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-22 01:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ece5603d-fc16-416e-a0a5-3217ce341ebb.git
$ cd ece5603d-fc16-416e-a0a5-3217ce341ebb
```
